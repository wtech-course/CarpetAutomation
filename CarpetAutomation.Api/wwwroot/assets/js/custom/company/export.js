...
var KTCustomersExport = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_modal_export_users"), a = new bootstrap.Modal(t), i = document.querySelector("#kt_modal_export_users_form"), e = i.querySelector("#kt_customers_export_submit"), n = i.querySelector("#kt_customers_export_cancel"), o = t.querySelector("#kt_customers_export_close"), r = FormValidation.formValidation(i, {
                fields: {
                    date: {
                        validators: {
                            notEmpty: {
